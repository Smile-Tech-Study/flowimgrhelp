...
**Внимание**: тренировочное приложение работает **только под Windows**. Установка на другие системы в настоящее время невозможна.

Перейдите [**по ссылке**](https://storage.yandexcloud.net/odin-exam-app/demo/win32/x64/Odin-0.0.2.exe) и сохраните тренировочное приложение на своё устройство.
