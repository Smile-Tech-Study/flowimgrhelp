...
6. Узнать у администратора Центра тестирования и записать для себя, когда и как можно узнать о результатах прохождения экзамена. Либо после проверки результаты будут доступны в ЛК на 10 шаге.
